...
export const Subject = mongoose.model('Subject', new Schema({
  ...
  yearId: { type: Schema.Types.ObjectId, ref: 'Year', required: true }, semesterId: { type: Schema.Types.ObjectId, ref: 'Semester', required: true }, facultyId: { type: Schema.Types.ObjectId, ref: 'User' },
